...
The function `gleebusOpen` has two parameters. The first parameter controls how many pages in the ring you'd like to travel. The second parameter is optional and controls whether the page is opened in a new tab.
